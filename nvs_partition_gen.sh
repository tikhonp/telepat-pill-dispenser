...
# get wifi from $1 and $2 or use defaults
# fix near if
if [ -n "$1" ] && [ -n "$2" ]; then
    echo "Using provided WiFi credentials."
    WIFI_SSID="$1"
    WIFI_PSK="$2"
else
